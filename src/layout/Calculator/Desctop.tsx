...
const Logo = () => <svg css={css`width: 7vw; @media(max-width: 768px){display: none}`} width="100" height="41"
    ...
    <rect width="100" height="40.4255" fill="url(#pattern6)"/>
    <defs>
        <pattern id="pattern6" patternContentUnits="objectBoundingBox" width="1" height="1">
            <use xlinkHref="#image6" transform="translate(0.00104627) scale(0.00108601 0.00269542)"/>
        </pattern>
        <image id="image6" width="912" height="371"
